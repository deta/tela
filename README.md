...
Tela is a declarative svelte library for creating infinite canvases, positioning elements on them, and handling all canvas related logic like moving elements, dragging, panning etc. Using tela, the example code below is all you need to get an infinite canvas up and running, position elements on it.
